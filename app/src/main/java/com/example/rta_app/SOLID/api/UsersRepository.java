...
public class UsersRepository implements IUsersRepository {
    ...
    private static final String URL_POST = "http://carlo4664.c44.integrator.host:10500/auth/login";
    ...
    private void updateMotoristaNome(String id, String nome) {
        String url = "http://carlo4664.c44.integrator.host:10500/api/motoristas/update/" + id;
